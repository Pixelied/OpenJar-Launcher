...
const EN_TRANSLATIONS = {
  ...
  "settings.appearance.theme.sub": "Switch between dark, light, pastel, and cyberpunk.",
  "settings.appearance.theme.dark": "Dark",
  "settings.appearance.theme.light": "Light",
  "settings.appearance.theme.pastel": "Pastel",
  "settings.appearance.theme.cyberpunk": "Cyberpunk",
...
const ES_TRANSLATIONS: TranslationDictionary = {
  ...
  "settings.appearance.theme.sub": "Cambia entre oscuro, claro, pastel y cyberpunk.",
...
const FR_TRANSLATIONS: TranslationDictionary = {
  ...
  "settings.appearance.theme.sub": "Basculez entre sombre, clair, pastel et cyberpunk.",
...
const DE_TRANSLATIONS: TranslationDictionary = {
  ...
  "settings.appearance.theme.sub": "Zwischen dunkel, hell, Pastell und Cyberpunk wechseln.",
  "settings.appearance.theme.dark": "Dunkel",
  "settings.appearance.theme.light": "Hell",
  "settings.appearance.theme.pastel": "Pastell",
  "settings.appearance.theme.cyberpunk": "Cyberpunk",
...
const PT_TRANSLATIONS: TranslationDictionary = {
  ...
  "settings.appearance.theme.title": "Tema",
  "settings.appearance.theme.sub": "Alterne entre escuro, claro, pastel e cyberpunk.",
